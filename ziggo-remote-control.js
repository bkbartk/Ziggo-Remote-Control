...
<!-- ################################# MEDIA CONTROL ################################# -->
                 <div class="grid-container-media-control" >
                      ...
                      <button class="btn-flat flat-low ripple"  @click=${() => this._media_player_service("media_player","media_play_pause")}><ha-icon icon="mdi:${stateObj.attributes.state === 'playings'  ? 'pause' : 'play'}"/></button>
